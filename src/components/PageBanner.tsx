  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1320px] px-5 text-center sm:px-6 lg:px-0">
        <div className="text-[14px] text-[var(--color-ink-soft)] sm:text-[16px]">
          <Link
            href="/"
        ...
        <h1 className="mt-4 font-[family-name:var(--font-radio-canada-big)] text-[26px] font-bold leading-[1.1] tracking-[-0.01em] text-[var(--color-ink)] sm:mt-5 md:text-[36px] lg:text-[44px] xl:text-[56px]">
          {title}
        </h1>
      </div>
    </section>
