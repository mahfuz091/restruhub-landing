    ...
    >
      <div className="mx-auto w-full max-w-[1320px] px-5 sm:px-6 lg:px-0">
        ...
        <div className="mx-auto max-w-[760px] text-center">
          ...
          <p
            data-reveal
            className="mx-auto mt-4 max-w-[620px] text-[14px] leading-[22px] text-[var(--color-ink-soft)] sm:mt-6 sm:text-[16px] sm:leading-[26px] lg:text-[18px] lg:leading-[28px]">
        ...
        {/* dashboard thumbnail */}
        <div data-reveal="scale" className="mx-auto mt-10 max-w-[1140px] overflow-hidden rounded-t-[16px] shadow-[0_14px_64px_0_rgba(0,0,0,0.1)] sm:mt-14 sm:rounded-t-[20px] lg:mt-16 lg:rounded-t-[24px]">
          <Image
