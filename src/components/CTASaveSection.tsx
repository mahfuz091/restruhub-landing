      ...
      <div className="relative z-10 mx-auto w-full max-w-[1320px] px-5 sm:px-6 2xl:px-0">
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-col items-center gap-5 text-center sm:gap-6">
            <h2 className="mx-auto max-w-[820px] font-[family-name:var(--font-radio-canada-big)] text-[26px] font-semibold leading-[1.15] tracking-[-0.01em] text-[#001f0f] md:text-[36px] lg:text-[44px] xl:text-[56px]">
              Ready to Save{" "}
              <span className="text-[#009f6b]">$4,440 Per Year?</span>
            </h2>
            <p className="mx-auto max-w-[775px] text-[15px] font-medium leading-[1.7] tracking-[-0.01em] text-[#2b2d2c] sm:text-[18px]">
          ...
          {/* dashboard mockup */}
          <div className="relative mt-12 w-full max-w-[1125px] sm:mt-16">
            <Image
